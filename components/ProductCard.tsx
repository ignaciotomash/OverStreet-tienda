      ...
      >
        ...
        {onEliminar && (
          <button
            ...
            className="absolute right-2.5 top-2.5 z-20 flex h-8 w-8 items-center justify-center border-2 border-[#C1272D] bg-white text-[#C1272D] transition-colors hover:bg-[#C1272D] hover:text-white"
          >
